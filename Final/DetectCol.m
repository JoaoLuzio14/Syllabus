...
%y coordinate of the point that we want to check
...
hold on;
x2 = [243 250 258 105 100 100 96 87 66 56 1 1 243];
y2 = [1 119 213 222 96 90 57 45 36 34 41 1 1];
